...
public class Practice02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("당첨 로또 번호 : " + thisWeekLotto);
		
		int count = 0;
		
		for (Object o : myLotto) {
			
			if(thisWeekLotto.equals(o)) {
				count++;
			}
		}
		...
		System.out.println("일치하는 번호 개수 " + count + "개 (" + result + ")");
