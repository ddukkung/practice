...
//		f.setSize(600, 400);
		// 크기를 지정하는 setSize() 파라미터에 Dimension 객체 전달이 가능하며
...
//		f.setLocation(p);
		...
		// -> Rectangle 객체 생성 시 파라미터 x, y, width, height 전달하거나 
